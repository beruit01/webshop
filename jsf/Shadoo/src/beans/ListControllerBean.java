	...
	public ListControllerBean() {
		...
		exampleProducts
				.add(new ProductBean(
						...
						new GregorianCalendar(14, 2, 13), UserListBean
								.getAllUsers().get(1), "Fotos", ""));
		exampleProducts
				.add(new ProductBean(
						"Fahrrad fahren für Hipster",
						"resources/images/productPics/small/88H.jpg",
						3,
						500,
						new String[] { "Sport", "Fahrrad", "Hipster",
								"Alternativ" },
						"Für alle, die auch beim Fahrradfahren Individualität und Style zeigen wollen.",
						new GregorianCalendar(13, 5, 13), UserListBean
								.getAllUsers().get(0), "Sport", ""));
		exampleProducts
				.add(new ProductBean(
						"Die besten Stücke für den Posaunenchor",
						"resources/images/productPics/small/100H.jpg",
						4,
						30,
						...
						new GregorianCalendar(14, 5, 11), UserListBean
								.getAllUsers().get(2), "Kunst", ""));
		exampleProducts
				.add(new ProductBean(
						"Theater für Dummies",
						"resources/images/productPics/small/103H.jpg",
						1,
						22,
						...
						new GregorianCalendar(14, 1, 22), UserListBean
								.getAllUsers().get(0), "Kunst", ""));
		exampleProducts
				.add(new ProductBean(
						"Bahnfahren leicht gemacht",
						"resources/images/productPics/small/90H.jpg",
						2.5f,
						10,
						...
						new GregorianCalendar(14, 6, 16), UserListBean
								.getAllUsers().get(0), "Reisen", ""));
		exampleProducts
				.add(new ProductBean(
						"Dias in der Neuzeit",
						"resources/images/productPics/small/83H.jpg",
						5,
						10,
						...
						new GregorianCalendar(14, 1, 2), UserListBean
								.getAllUsers().get(1), "Foto", ""));
		exampleProducts
				.add(new ProductBean(
						"10 tolle Tipps für Oldtimer-Fans",
						"resources/images/productPics/small/95H.jpg",
						2,
						10,
						...
						new GregorianCalendar(14, 5, 19), UserListBean
								.getAllUsers().get(2), "Auto", ""));
		exampleProducts
				.add(new ProductBean(
						"Lustige Witze für zwischendurch",
						"resources/images/productPics/small/78H.jpg",
						4.5f,
						15,
						new String[] { "Humor", "Witze", "Unterhaltung" },
						"Stressiges Studium? Mit diesen Witzen wird ihr Tag noch gerettet",
						new GregorianCalendar(14, 2, 11), UserListBean
								.getAllUsers().get(2), "Kunst", ""));
		exampleProducts.add(new ProductBean("Romantischer Tangotanz",
				"resources/images/productPics/small/82H.jpg", 3, 10,
		...
		exampleProducts
				.add(new ProductBean(
						...
						"resources/images/productPics/small/85H.jpg",
						1.5f,
						3,
						...
						new GregorianCalendar(14, 4, 6), UserListBean
								.getAllUsers().get(1), "Kunst", ""));
		exampleProducts
				.add(new ProductBean(
						"Fashion-Accessoires zum Selbermachen",
						"resources/images/productPics/small/97H.jpg",
						4,
						10,
						...
						new GregorianCalendar(14, 1, 17), UserListBean
								.getAllUsers().get(1), "Mode", ""));
